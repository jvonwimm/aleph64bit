...
unalias cp
 ...
 set  ORIG =   $HOME/patchy        # origin directory for step jinst3/4
 set  TARG =   /usr/local/bin      # target directory
 set  FOPT  = "-O"                # Fortran compiler options
 set  FOPTC = "-c $FOPT"
 set  KERNLIB = '/home/wimmer/aleph64bit/cern/2005/lib/libpacklib.a'
...
# *******************************************************
# *                                                     *
# *  modify routines to make them gfortran compatible   *
# *                                                     *
# *******************************************************
...
q
!
mv yshtag.ft yshtag.f

ed jartpx.f <<!
19c
      PARAMETER   ( NBLANK = Z'20202000' )
.
w jartpx.ft
q
!
mv jartpx.ft jartpx.f
...
q
!
mv cctoup.ft cctoup.f

ed iofile.f <<!
23c
      CHARACTER*8  ACTION(8)                                            -A6M
.
w iofile.ft
q
!
mv iofile.ft iofile.f
...
# *  delete code which will be taken from kernlib
# *  this is not an elegant method but the easiest
rm *.c
rm cb* cf* cl* ct* cu*
rm iu*
rm jb* jrs*
...
step14:
 ...
 set  CLD  = 'gfortran -no-pie'
 
 $CLD   -o ypatchy  ypatch.o   libp4lib.a  $KERNLIB
 $CLD   -o ytobcd   ytobcd.o   libp4lib.a  $KERNLIB
 $CLD   -o ytobin   ytobin.o   libp4lib.a  $KERNLIB
 $CLD   -o ytoceta  ytocet.o   libp4lib.a  $KERNLIB
 $CLD   -o yfrceta  yfrcet.o   libp4lib.a  $KERNLIB
 $CLD   -o ycompar  ycompa.o   libp4lib.a  $KERNLIB
 $CLD   -o yedit    yedit.o    libp4lib.a  $KERNLIB
 $CLD   -o yindex  yindex.o   libp4lib.a  $KERNLIB
 $CLD   -o ylist   ylist.o    libp4lib.a  $KERNLIB
 $CLD   -o ysearch  ysearc.o   libp4lib.a  $KERNLIB
 $CLD   -o yshift   yshift.o   libp4lib.a  $KERNLIB
...
jinst3:
 ...
 mv -f  $TARG/yindex   $TARG/yindex.prev
 mv -f  $TARG/ylist    $TARG/ylist.prev     
...
jinst4:
 ...
 mv -f  $ORIG/yindex   $TARG/yindex
 mv -f  $ORIG/ylist    $TARG/ylist
