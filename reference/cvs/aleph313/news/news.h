   on AXP/VMS:
              source:  ALEPH313:[*]*.F,ALEPH313:[INC]*.h
              library: ALE:ALEPHLIB.OLB, _D.OLB, .NEWS

   on UNIX :  source:  $ALROOT/aleph313/*/*
              library: $ALEPH/gen/libalephlib.a     -> libalephio313.a
              library: $ALEPH/gen/libalephlib_dbx.a -> libalephio313_dbx.a
