#if defined(DOC)
   on AXP/VMS:
        source:  JUL309:[*]*.F,JUL309:[INC]*.h
        library: JUL:JUL309.OLB, _D.OLB, .NEWS
        program: JUL:JUL309.EXE, _D.EXE


   on UNIX :  source:    $ALROOT/jul309/?_
              library:   $ALEPH/jul/libjul309.a  _dbx.a
              program:   $ALEPH/jul/jul309.1
