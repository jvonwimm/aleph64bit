$!========================================================================
$!
$! Name      : AL1$USER0:[RANJARD.DBASE]UPDATE_BANK.COM
$!
$! Purpose   : create ADD, LBF, HAC for all .DDL
$!             prepare SBANK
$!             update BANKAL and SBANK
$!
$! Arguments :
...
$ CSP/LOG BANKDOC:GENATTR,BKDOCDIR:ADBSCONS.DDL -
  BKDOCDIR:ADBSCONS/CREATE/ADD_SIZE=2000000
...
$ COPY BANKAL.HAC,RUNBANK.HAC BKDOCDIR:BANKAL.HAC
$!
