   on AXP/VMS:
              source:  ALEPH312:[*]*.F,ALEPH312:[INC]*.h
              library: ALE:ALEPHLIB.OLB, _D.OLB, .NEWS

   on UNIX :  source:  $ALROOT/aleph312/*/*
              library: $ALEPH/gen/libalephlib.a     -> libalephio312.a
              library: $ALEPH/gen/libalephlib_dbx.a -> libalephio312_dbx.a
