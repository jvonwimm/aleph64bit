*CD news
C! last changes
   GAL:TPCSIM.HLB, .FOR, .OLB, _D.OLB, .NEWS

   TPCSIM OLDLIB GAL, TXTLIB, NEWS

   TPCSIM CRAYLIB CRAYXU.401
   $KEEP/tpcsim.lib

   ALEPH DECS stations, SHIFT and CSF :
   source is on      /aleph/src/srctpcsim
   library           /aleph/lib/libtpcsim.a
   debug library     /aleph/gal/libtpc300_dbx.a
   ---------------------------------------------------------------
 ! TPCSIM 300   941209   16.00
