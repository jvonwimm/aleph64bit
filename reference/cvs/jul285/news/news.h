   ...
   on AXP/VMS:
        source:  JUL285:[*]*.F,JUL285:[INC]*.h
        library: JUL:JUL285.OLB, _D.OLB, .NEWS
        program: JUL:JUL285.EXE, _D.EXE


   on UNIX :  source:    $ALROOT/jul285/?_
              library:   /aleph/jul/libjul285.a  _dbx.a
              program:   /aleph/jul/jul285.1
