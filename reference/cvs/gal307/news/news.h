...
#if defined(DOC)
   on AXP/VMS:
             $ define GAL307 $2$DKB200:[GENERAL_A.GAL.GAL307]
             $ define ALINC  $2$DKB200:[GENERAL_A.ALE.INC]

              source on GAL307:*.F, *.h 

              library   GAL:GAL307.OLB, _D.OLB, .NEWS
   
   on UNIX :  source on $ALROOT/gal307/
                        $REFERENCE/gal/ifinter.f
              library   $ALEPH/gal/libgal307.a
                        $ALEPH/gal/libgal307_dbx.a
                        $ALEPH/gal/ifinter307.o
