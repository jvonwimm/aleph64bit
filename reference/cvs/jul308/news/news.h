#if defined(DOC)
   on AXP/VMS:
        source:  JUL308:[*]*.F,JUL308:[INC]*.h
        library: JUL:JUL308.OLB, _D.OLB, .NEWS
        program: JUL:JUL308.EXE, _D.EXE


   on UNIX :  source:    $ALROOT/jul308/?_
              library:   /aleph/jul/libjul308.a  _dbx.a
              program:   /aleph/jul/jul308.2
