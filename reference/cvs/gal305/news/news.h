...
#if defined(DOC)
   on AXP/VMS: 
             $ define GAL305 $2$DKB200:[GENERAL_A.GAL.GAL305]
             $ define ALINC  $2$DKB200:[GENERAL_A.ALE.INC]

              source on GAL305:*.F, *.h 

              library   GAL:GAL305.OLB, _D.OLB, .NEWS
   
   on UNIX :  source on $ALROOT/gal305/
                        /al/reference/gal/ifinter.f
              library   /aleph/gal/libgal305.a
                        /aleph/gal/libgal305_dbx.a
                        /aleph/gal/ifinter305.o
