#if defined(DOC)
   on AXP/VMS:
        source:  JUL311:[*]*.F,JUL311:[INC]*.h
        library: JUL:JUL311.OLB, _D.OLB, .NEWS
        program: JUL:JUL311.EXE, _D.EXE


   on UNIX :  source:    $ALROOT/jul311/?_
              library:   $ALEPH/jul/libjul311.a  _dbx.a
              program:   $ALEPH/jul/jul311.0
