   on AXP/VMS:
              source:  ALEPH315:[*]*.F,ALEPH315:[INC]*.h
              library: ALE:ALEPHLIB.OLB, _D.OLB, .NEWS

   on UNIX :  source:  $ALROOT/aleph315/*/*
              library: $ALEPH/gen/libalephlib.a     -> libalephio315.a
              library: $ALEPH/gen/libalephlib_dbx.a -> libalephio315_dbx.a
