...
#if defined(DOC)
   on AXP/VMS: 
             $ define GAL306 $2$DKB200:[GENERAL_A.GAL.GAL306]
             $ define ALINC  $2$DKB200:[GENERAL_A.ALE.INC]

              source on GAL306:*.F, *.h 

              library   GAL:GAL306.OLB, _D.OLB, .NEWS
   
   on UNIX :  source on $ALROOT/gal306/
                        /al/reference/gal/ifinter.f
              library   /aleph/gal/libgal306.a
                        /aleph/gal/libgal306_dbx.a
                        /aleph/gal/ifinter306.o
