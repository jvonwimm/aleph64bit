...
#if defined(DOC)
   on AXP/VMS: 
             $ define GAL304 $2$DKB200:[GENERAL_A.GAL.GAL304]
             $ define ALINC  $2$DKB200:[GENERAL_A.ALE.INC]

              source on GAL304:*.F, *.h 

              library   GAL:GAL304.OLB, _D.OLB, .NEWS
   
   on UNIX :  source on $ALROOT/gal304/
                        /al/reference/gal/ifinter.f
              library   /aleph/gal/libgal304.a
                        /aleph/gal/libgal304_dbx.a
                        /aleph/gal/ifinter304.o
