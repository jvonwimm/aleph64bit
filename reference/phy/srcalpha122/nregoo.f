...
C!   ===========
C!
C?   This subroutine gets all the goodies from the NanoDst and makes the
C?   accessible inside ALPHA. To use the names from SANDY for those  who
C?   it before and to avoid problems with ALPHA conventions all variable
...
C--------------------- end of QCDE ------------------------------------
     ...
     +          JNEHY2=17,JNEHZ2=18,JNEHB1=19,JNEHB2=20,LNEHEA=20)
      INTEGER JNDSMT,JNDSLP,JNDSUP,JNDSCT,JNDSIH,JNDSTH,JNDSD0,JNDSZ0,
     &  JNDSJL,JNDSJU,JNDSJC,JNDSJI,JNDSJT,JNDSJD,JNDSJZ,JNDSJY,JNDSVE,
     &  JNDSRO,JNDSLE,JNDSPH,JNDSNP,JNDSPB,JNDSNR,JNDSRB,JNDSNN,JNDSNB,
     &  JNDSPR,JNDSAV,JNDSDA,JNDSMC,JNDSMM,JNDSAL,JNDSCE,JNDSME,JNDSEM,
     &  JNDSCS,JNDSCB,LNDSTA
     ...
     +          JNDSAL=145,JNDSCE=146,JNDSME=147,JNDSEM=148,JNDSCS=149,
     +          JNDSCB=150,LNDSTA=150)
