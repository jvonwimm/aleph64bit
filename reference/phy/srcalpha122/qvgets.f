...
C
      S(1,1) = RW(J1(JQVEEM  ))
      S(1,2) = RW(J1(JQVEEM+1))
      S(2,1) = S(1,2)
      S(2,2) = RW(J1(JQVEEM+2))
      S(1,3) = RW(J1(JQVEEM+3))
      S(3,1) = S(1,3)
      S(2,3) = RW(J1(JQVEEM+4))
      S(3,2) = S(2,3)
      S(3,3) = RW(J1(JQVEEM+5))
      S(1,4) = RW(J1(JQVEEM+6))
      S(4,1) = S(1,4)
      S(2,4) = RW(J1(JQVEEM+7))
      S(4,2) = S(2,4)
      S(3,4) = RW(J1(JQVEEM+8))
      S(4,3) = S(3,4)
      S(4,4) = RW(J1(JQVEEM+9))
C
      END
