...
C  Modified : G.Graefe                       25-MAR-1995 adapted to Nano
C
C  Input Arguments :
C
...
C       ANY NEGATIVE ELEMENT OF BSIZ WILL SUPPRESS INTERNAL PRIMARY FIND
...
C       OR THAT SOME TRACKS COME FROM THE SECONDARY AND SOME FROM PRIMAR
