...
C! Output: DXY = the distance(cm) in the xy plane at the closest approac
C!         DZ2 = the distance(cm) between the tracks in z at the xy poin
...
C!         NC1(2) = 0
C!         DIN1(2) = 0
C!         P(3) = Summed momentum of the two tracks at the materializati
C!                point
C!         IER = 0 if all OK
...
C!   ===========
C!
C?   This subroutine looks in the NDGC bank if the both tracks given for
C?   converted gamma. The routine is called inside ALPHA instead of PAIR
