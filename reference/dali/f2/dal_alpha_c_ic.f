...
C              12345678901234567890123456789012345678901234567890
      ...
      DATA T2/'RM_123 opt=EF HC_12 YD_12345 YJ_123 YL_123 YI_123'/
...
C     ::.::::::::::::::::::::::::::::::::::::::::::::::::::::
      CALL DPARP0
      CALL DPAROP(100,'AHC_AYJ_AYD_AYL_AYI_AEV')
...
C      END IF
      ...
      IF(TANSW.EQ.'JD') THEN
        ...
        TANSW='jt'
      END IF
      CALL DO_STR('JL: Luclus jet 10.11.1')
      IF(TANSW.EQ.'JL') THEN
        NCAL=NCALDA
        CALL DV_QVEC_SET_OPT(TOPS)
        IF(TLOCK.EQ.' ') THEN
          CALL DV_QVEC_LUCLUS(19,NJETS,LIST)
        ELSE
          CALL DV_QVEC_LOCK
          CALL DV_QVEC_LUCLUS(19,NJETS,LIST)
          CALL DV_QVEC_UNLOCK
        ...
        TANSW='jt'
      END IF
      CALL DO_STR('JI: Diclus jet 10.11.1')
      IF(TANSW.EQ.'JI') THEN
        NCAL=NCALDA
        CALL DV_QVEC_SET_OPT(TOPS)
        IF(TLOCK.EQ.' ') THEN
          CALL DV_QVEC_DICLUS(19,NJETS,LIST)
        ELSE
          CALL DV_QVEC_LOCK
          CALL DV_QVEC_DICLUS(19,NJETS,LIST)
          CALL DV_QVEC_UNLOCK
