...
C              123456789 123456789 123456789 123456789 123456789
      DATA TV/'Vertex det.: unconnected hits, good coord. MV$1'/
C                           ============      ====
...
C     ::.::::::::::::::::::::::::::::::::::::::::::::::::::::
      ...
      CALL DPARP0
      CALL DPAROP(20,'HTB_HMV_HP0_HSE_HNI_HNT_HCM_HZ0_HD0_HF1_HF2')
      CALL DPAROP(20,'HT1_HT2_HZZ_HST_HSH_HDE_HCN_HCQ_HCE_HCL')
C     ::.::::::::::::::::::::::::::::::::::::::::::::::::::::
      CALL DCOPTL
  930 CALL DO_BAR_STATUS_0
      ...
      IF(IHTRDO(1).LT.6) THEN
        ...
        IF(     IHTRDO(1).EQ.1) THEN
          T0( 9: 9)='I'
          T0(19:49)=' '
          CALL DO_BAR_STATUS('HI',0,T1)
        ELSE IF(IHTRDO(1).EQ.3) THEN
          T0(21:21)='R'
          T0( 7:19)=' '
          CALL DO_BAR_STATUS('TR',0,T1)
        ELSE
          CALL DO_BAR_STATUS('HT',0,T1)
        END IF
        IF(IHTRDO(1).LE.2) THEN
          CALL DO_BAR_STATUS(TAUTF(IHTRDO(5)),16,T0)
C         T0(16:16)=TAUTF(IHTRDO(5))
          IF(     IHTRDO(6).EQ.2) THEN
            CALL DO_BAR_STATUS('PA',13,T0)
            T0(16:17)=DT2(PARADA(2,J_HSE))
          ELSE IF(IHTRDO(6).EQ.3) THEN
            CALL DO_BAR_STATUS('BC',13,T0)
          ELSE
            CALL DO_BAR_STATUS('CD',13,T0)
          END IF
        END IF
     ...
     &       IHTRDO(2).GE.4) THEN
C           ............................................. CH KI KO KH
            CALL DO_BAR_STATUS(TTR(IHTRDO(2)),27,T0)
            T0(31:49)=' '
          ELSE
            IF(IHTRDO(2).EQ.3) THEN
              CALL DO_BAR_STATUS('MC',27,T0)
 ...
 1934   CALL DTYPT('TYPE',TPICDO,N_1_DA,N_2_DA,PARADA,TPOPDA,T0)
      ...
      IF(FACT.AND.IHTRDO(1).LE.2) THEN
        IF(PARADA(2,J_HCA).NE.0.) THEN
          T3(20:22)=' '
          CALL DO_BAR_STATUS('CA',0,' ')
        ELSE
          CALL DO_BAR_STATUS('CT',0,' ')
          T3(20:22)='not'
        END IF
...
C     ................ changed 11-MAR-1999 to avoid jump into loop. see below
C     IF(FTV) THEN
C 935   TV(14:24)=TVHT(IFIX(PARADA(2,J_HVD)))

  935 IF(FTV) THEN
        TV(14:24)=TVHT(IFIX(PARADA(2,J_HVD)))
        TV(32:35)=TVCT(IFIX(PARADA(4,J_HVD)))
        CALL DTYPT('TYPE',' ',N_1_DA,N_2_DA,PARADA,TPOPDA,TV)
      END IF
...
C      PARADO(2,IHCODO)=SIGN(PARADO(2,IHCODO),PCOL)
  ...
  770    CONTINUE
      ...
      IF(TANSW.EQ.'VD') THEN
C       FTV=.FALSE.
C       ............. changed 11-MAR-1999 to avoid jump into loop. see above
        FTV=.TRUE.
        PARADA(2,J_HVD)=2.
        PARADA(4,J_HVD)=1.
        GO TO 935
