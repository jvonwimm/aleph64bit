...
C     .............................................................. OPERATOR
  936 CALL DGZOOM(6,IAREDO,0,0)
     ...
     &  NEXEC,FCHG,TANSW)
      CALL DGZOOM(6,-1,0,0)
C     ................................................................... PICK
C      IF(TANSW.EQ.'PI'.AND.NEXEC.EQ.2) THEN
C        IRC=0
C        CALL DPOS(TANSW,FDUM,TDUM,NEXEC,FCHG)
...
C-------------------End of DALI_CF commons----------------
      ...
      END IF
      CALL DQCL(IAREDO)
      IF(.NOT.FPIKDP) CALL DQFFWI(LEVA)
...
C
      DIMENSION HRB(4),VRB(4)
      DATA Q1/0.0/,Q2/0.000000005/,DS/20./,SFAC/.97/
      DIMENSION IP(2)
      DATA IP/2,9/,NDASH/2/
C
      DIMENSION XYZSQ(3,8)
...
C               ............................................ draw crosses
   ...
   10 END DO
      ...
      CALL DGCHKX
      IF(FNINT) RETURN
   20 IF(DGPNTR(JHC,JVC,FBUT)) THEN
        IF(FBUT(1)) THEN
          GO TO 20
        ELSE IF(FBUT(3)) THEN
          CALL DTYANS(
