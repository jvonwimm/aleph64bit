...
C
C   This is a UNIX version first prepared on 2-Feb-1993.
C
...
C     & Status
      INTEGER Istat, iargc, Len_Str, Flag, I1, I2,
     & Status
      INTEGER Ilen
...
C
      ...
      Character*(*) string
      Integer LineNo
      Character*8 Cond_Ident(NIdents) /'UNIX    ', 'OSF    '/, TC
      Integer I, L1, L2
      Integer I2
