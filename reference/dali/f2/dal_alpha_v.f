...
CH ---------------------------------------------------------- DV_QVEC_LUCLUS
CH
      ENTRY DV_QVEC_LUCLUS(MAXJ,NJETS,LIST,IOBJ)
CH
CH --------------------------------------------------------------------
CH
      CALL DPARGV(100,'AYL',2,YCUT)
      CALL DPARGV(100,'AEV',2,EVIS)
      TNAM='QIPBJETS'
C     TNAM='JJETS'
      CALL QJLUCL74(NJETS,TNAM,KRECO,1,0.04,YCUT,1,TGEN,DMIN)
      CALL DPARGI(98,'AJL',JCOL)
      GO TO 700
CH
CH
CH ---------------------------------------------------------- DV_QVEC_DICLUS                      
CH                                                                                                 
      ENTRY DV_QVEC_DICLUS(MAXJ,NJETS,LIST,IOBJ)
CH                                                                                                
CH --------------------------------------------------------------------                           
CH                                                                                                
      CALL DPARGV(100,'AYI',2,YCUT)
      CALL DPARGV(100,'AEV',2,EVIS)
      TNAM='QIPBJETS'
C     TNAM='JJETS'                                                                                
      CALL QJDICL(NJETS,TNAM,KRECO,YCUT,PTNEXT,20,2,1,2)
      CALL DPARGI(98,'AJI',JCOL)
      GO TO 700
CH                                                                                                
CH
CH
