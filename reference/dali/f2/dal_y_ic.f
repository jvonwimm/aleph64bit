...
C     :::::::::::::::::::::::::::::::::::::::::::::::::::::::
      TPARDA=
     &  'J_PFI,J_PFR,J_PTO,J_PAS,J_PBX'
      CALL DPARAM(11
     &  ,J_PFI,J_PFR,J_PTO,J_PAS,J_PBX)
C     ::.::::::::::::::::::::::::::::::::::::::::::::::::::::
      MODEB=PARADA(2,J_PBX)
C      IF(PARADA(2,J_PBM).EQ.1.) THEN
C         HM=0.5*(HRB(1)+HRB(3))
C         VM=0.5*(VRB(1)+VRB(3))
...
C     ::.::::::::::::::::::::::::::::::::::::::::::::::::::::
      ...
      ELSE
        ...
        IF(PSTODS(1,J_PBX,IAREDO,IWUSDO).GE.3.)
...
CH ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  DYZRBC
CH
      SUBROUTINE DYZ_CONE_TO_HV(HRB,VRB)
CH
CH ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
CH
*CA DALLCO
...
C     :::::::::::::::::::::::::::::::::::::::::::::::::::::::
      TPARDA=
     &  'J_PTE,J_PFR,J_PTO,J_PAS,J_PBY,J_RDY'
      CALL DPARAM(10
     &  ,J_PTE,J_PFR,J_PTO,J_PAS,J_PBY,J_RDY)
C     ::.::::::::::::::::::::::::::::::::::::::::::::::::::::
      ...
      IF(PARADA(2,J_PBY).NE.3.) DV=DV/PARADA(2,J_PAS)
...
C     :::::::::::::::::::::::::::::::::::::::::::::::::::::::
      TPARDA=
     &  'J_PFI,J_PFR,J_PTO,J_PAS,J_PDS,J_PBX,J_PSW,J_PHM'
      CALL DPARAM(10
     &  ,J_PFI,J_PFR,J_PTO,J_PAS,J_PDS,J_PBX,J_PSW,J_PHM)
      TPARDA=
     &  'J_CFL'
...
C           .................................... calculate scales
          ...
          ELSE
C           .................................... calculate scales
            SCA(1)=PARADA(2,J_PFR)
            SCA(2)=PARADA(2,J_PTO)
            SCA(4)=0.5*ABS(SCA(2)-SCA(1))/PARADA(2,J_PAS)
            SCA(3)=-SCA(4)
            TH='X'''
            TV='Y'''
          END IF
...
C     SCALDS(IAREDO,MSECDS)=Q*AHSCDQ
    ...
    3    CONTINUE
      END IF
C      IF(HIMXDU.EQ.0.) THEN
C        HIMAX=999.
C      ELSE
C        HIMAX=QSCL(IRHST)+0.01
C      END IF
      IF(FPIKDP) THEN
        MDLRDP=2010
        MODD=1
...
CCH ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  DYXRCB
CCH
C      SUBROUTINE DYXRCB(HRB,VRB,TH,TV,S)
CCH
CCH ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
CCH
CC ---------------------------------------------------------------------
...
CC     :::::::::::::::::::::::::::::::::::::::::::::::::::::::
C      TPARDA=
C     &  'J_PFI,J_PFR,J_PTO,J_PAS,J_PBX'
C      CALL DPARAM(11
C     &  ,J_PFI,J_PFR,J_PTO,J_PAS,J_PBX)
CC     ::.::::::::::::::::::::::::::::::::::::::::::::::::::::
C      FI=PARADA(2,J_PFI)
...
C            END IF
          ...
          DO 4 K=1,JBIN
            EWIR(K)=EWIR(K)*Q
    4     CONTINUE
C          IF(HIMXDU.EQ.1.) THEN
C            DO 14 K=1,JBIN
C              EWIR(K)=MIN(EMX,EWIR(K))
C   14       CONTINUE
C          END IF
          H=RO(MS)*COSD(FI)
          V=RO(MS)*SIND(FI)
...
c         IF(PARADU(44).NE.0.) THEN
c           IF(PARADA(2,J_PTE).GT.90..AND.IZOMDO.EQ.1)ISGN=-ISGN
c         END IF
