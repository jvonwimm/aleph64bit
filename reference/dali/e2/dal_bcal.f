...
C                  0    1    2    3    4    5    6    7    8
      ...
      LOGICAL FCHG
      CHARACTER *49 TP38,TP102,T1,T2,T3
      DATA TP38/'BDR_BSE_BCE'/
      DATA TP102/'BBC_BLI_BLW_BHI_BOV_BTX_BCC_BWC_BSC_BTR'/
C              123456789 123456789 123456789 123456789 123456789
      DATA T1/'P?:W?:BCAL AB rz   DR$123  SE_123  CE$1234'/
      DATA T2/'BC_12 LI_12 LW_1     TX_12'/
      DATA T3/'      HI_12 OV_12    CC$12 WC_1 SC_12      TR_12'/
C     :::::::::::::::::::::::::::::::::::::::::::::::::::::::
      CALL DPARP0
      CALL DPAROP(38,TP38)
...
C     :::::::::::::::::::::::::::::::::::::::::::::::::::::::
  ...
  936 FCHG=.FALSE.
     ...
     &  NEXEC,FCHG,TANSW)
      CALL DGZOOM(6,-1,0,0)
      CALL DPOS(TANSW,PDUM,PDUM,NEXEC,FCHG)
