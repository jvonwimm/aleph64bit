/*
 * Setting names to ADOBE-FONTSPECIFIC symbol mapping.
 */
	static char *ADOBE_Codes[] = {
		"NULL", "NULL", "NULL", "NULL",
		"NULL", "NULL", "NULL", "NULL", 
		"NULL", "NULL", "NULL", "NULL",
		"NULL", "NULL", "NULL", "NULL", 
		...
		"logicalnot",	"locicaland",	"logicalor",	"arrowdblboth",
		...
		"NULL",			"angleright",	"integral",		"integraltp",
