...
C
      ...
      REAL PT(2),P(2)                 !Track transverse momentum & momen
      ...
      REAL A(3,3,2)                   !Error matices for 1st 3 helix par
      INTEGER IDX(3,3)                !Translate from symmetrix matrix f
