...
C!    AMCON ........MASS CONSTRAINT
C!    DMQCON ........MASS SQUARE CONSTRAINT ERROR
C!
C! OUTPUT
...
C
  ...
  281   FORMAT('  YFVMC:  NHX+NEU=',I3,'+',I3,
     &     ' ABOVE ALLOWED MAXIMUM',I5)
        IFAIL=11
        GOTO 997
      ENDIF
...
C
      IF(ITER.LE.1) THEN
        CHISM=(AMM0Q/DMM0Q)**2
        CHISO=CHISO+CHISM
C     PRINT * ,' ITER=',ITER,' AMCON,DMQCON',AMCON,DMQCON,
...
C
      ...
      DO 6000 ITR=1,NTR
        DO 6000 I=1,3
          CEPI=FES*FPI(I,ITR)/FPI(4,ITR)-FPS(I)
          DO 6000 II=1,3
            IX=3*ITR+II
            ...
            DO 6000 JTR=1,NTR
              DO 6000 J=1,3
                CEPJ=FES*FPI(J,JTR)/FPI(4,JTR)-FPS(J)
                DO 6000 JJ=1,3
                  JX=3*JTR+JJ
