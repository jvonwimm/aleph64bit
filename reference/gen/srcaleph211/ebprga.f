...
C        SHAP(2) are estimated, the electromagnetic nature of the cluste
...
C        above the thresholds the materialisation depth is evaluated fro
C        a parametrisation .
...
C   Limits on energy.
      PARAMETER( EMIN = .050 , EMAX = 80. , NATU = 2 )
