...
C     H.Videau      Creation 15/12/85   Modification le 03/02/88
C! Quasi linear search on planes
C  Makes a quasi linear search through the planes of a pencil to find
C  the ones surrounding the point.
...
C  attention modifs une carte en moins
      ICOLD = 1
      ICNEW = NPLANS
