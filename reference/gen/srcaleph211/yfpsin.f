...
C        psi angles (mod twopi) calling Yfixyp, define psi phases (and s
C        minimizing also the z distance (see also the aleph note about v
C        When the projected helices have two points of intersection
C        there are  three solutions -> six psi angles (see aleph notes).
C        In this case: calculates the psi phases for any possible soluti
