...
*//////////////////////////////////////////////////////////////////////////////
      ...
      DOUBLE COMPLEX  m_AmpExpo0, m_AmpExpo1, m_AmpExpo2
      DOUBLE COMPLEX  m_Rmat
      DOUBLE COMPLEX  m_IntReson, m_BoxGGtu,  m_BoxGZtu,  m_BoxGGut,  m_BoxGZut
      DOUBLE COMPLEX  m_F1ini1,   m_F1fin1,   m_F1ini2,   m_F1fin2
      ...
      DOUBLE PRECISION      m_RhoExp0,      m_RhoExp1,       m_RhoExp2
...
*
     ...
     $    m_KeyISR,               ! ISR switch
     $    m_KeyFSR,               ! FSR switch
     $    m_KeyINT,               ! INTerference switch
     $    m_KeyGPS,               ! CEEX level switch
