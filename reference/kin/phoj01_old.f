...
C------------------------------------------------------------           ASKUSI 3
C! Written A.J.FINCH 3/11/1995                                          ASKUSI 4
C! Interface routine for PHOJ01 generator -Initialisation               ASKUSI 5
C!     output arguments :                                               ASKUSI 6
C!          IGCOD /I : Generator identification code                    ASKUSI 7
C------------------------------------------------------------           ASKUSI 8
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)                               ASKUSI 9
      SAVE                                                              ASKUSI10
C                                                                       ASKUSI11
...
C                                                                       ASKUSI15
C                                                                       ASKUSI16
      PARAMETER (NMAXD=100)                                             ASKUSI17
      COMMON /DEBUG/ IDEB(NMAXD),KSPOM,KHPOM,KSREG,KHDIR,KACCEP,        ASKUSI18
     &  KSTRG,KHTRG,KSLOO,KHLOO,KSDPO,KHDPO,KEVENT,KSOFT,KHARD          ASKUSI19
C                                                                       ASKUSI20
      COMMON /LEPCUT/ ECMIN,ECMAX,EEMIN1,EEMIN2,                        ASKUSI21
     &                YMIN1,YMAX1,YMIN2,YMAX2,                          ASKUSI22
     &                Q2MIN1,Q2MAX1,Q2MIN2,Q2MAX2,                      ASKUSI23
     &                THMIN1,THMAX1,THMIN2,THMAX2                       ASKUSI24
                                                                        ASKUSI25
C                                                                       ASKUSI26
      common /evtsta/nevent(10)                                         BBL001 1
      REAL EJMN1,AMAX                                                   ASKUSI27
      REAL AVERS                                                        ASKUSI28
                                                                        ASKUSI29
      PARAMETER(KINTYP=6009)                                            ASKUSI30
      PARAMETER(NVERS=102)                                              ASKUSI31
      IGCOD = KINTYP                                                    ASKUSI32
      AVERS = NVERS/100.0                                               ASKUSI33
C                                                                       ASKUSI34
C                                                                       ASKUSI35
      WRITE(IW(6),601)IGCOD,AVERS                                       ASKUSI36
601   FORMAT(/////,15X,'---------------------------------------'/,      ASKUSI37
     1             15X,'-                                     -'/,      ASKUSI38
     1             15X,'-             P H O J 0 1             -'/,      ASKUSI39
     1             15X,'-            ===============          -'/,      ASKUSI40
     1             15X,'-            generator code ',I5,'     -'/,     ASKUSI41
     1             15X,'-            version ',F5.2,'            -'/,   ASKUSI42
     1             15X,'-                                     -'/,      ASKUSI43
     1             15X,'-   Aleph interface to PHOJET         -'/,      ASKUSI44
     1             15X,'-   Author: A.J.Finch                 -'/,      ASKUSI45
     1             15X,'-   (A.Finch@lancaster.ac.uk)         -'/,      ASKUSI46
     1             15X,'-  last modification  13 May 1997     -'/,      BBL001 2
     1             15X,'---------------------------------------',       ASKUSI48
     1        /////)                                                    ASKUSI49
                                                                        ASKUSI50
      WRITE(6,*)                                                        ASKUSI51
      WRITE(6,*) ' ===================================================' ASKUSI52
      WRITE(6,*) '  ---------- PHOJET v.1.05b(27-Apr-96) ----------- '  ASKUSI53
      WRITE(6,*) ' ===================================================' ASKUSI54
      WRITE(6,*) '       please send suggestions / bug reports to:'     ASKUSI55
      WRITE(6,*) '     eng@tph200.physik.uni-leipzig.de (Ralph Engel)'  ASKUSI56
      WRITE(6,*) ' ===================================================' ASKUSI57
      WRITE(6,*)                                                        ASKUSI58
C                                                                       ASKUSI59
C  standard initializations                                             ASKUSI60
C                                                                       ASKUSI61
      CALL PHODAT                                                       ASKUSI62
      CALL HADDAT                                                       ASKUSI63
...
C                                                                       ASKUSE65
     ...
     &                KFDP(L2PARF,5)                                    LUCOM  9
      ...
      COMMON /LUJETS/ N7LU,K7LU(LJNPAR,5),P7LU(LJNPAR,5),V7LU(LJNPAR,5) LUCOM 12
                                                                        ASKUSE67
      COMMON /PROCES/ IPROCE,IDNODF,IDIFR1,IDIFR2,IDDPOM,IPRON(15)      ASKUSE68
      common /evtsta/nevent(10)                                         BBL001 5
      DIMENSION P1(4),P2(4)                                             ASKUSE70
                                                                        ASKUSE71
      REAL*4 VRTEX(4),SDVRT(3),RX,RY,RZ                                 ASKUSE72
      real*4 EBEAM,WMIN,ELEC(5),POSI(5),LUMIF,QQ1,QQ2                   ASKUSE73
                                                                        ASKUSE74
      LOGICAL FIRST,DEBUG,KEEP,KSTD,KUSR                                BBL001 6
                                                                        ASKUSE76
      DATA    FIRST/.TRUE./                                             ASKUSE77
      DATA    ICALL/0/,IFAIL/0/                                         ASKUSE78
      DATA    VRTEX/0.0,0.0,0.0,0.0/                                    ASKUSE79
      DATA    SDVRT/0.0180,0.0010,1.00 /                                ASKUSE80
C-------------------------------------------------------------------    ASKUSE81
C                                                                       ASKUSE82
C INITIALISE OUTPUT ARGUMENTS                                           ASKUSE83
C                                                                       ASKUSE84
C-------------------------------------------------------------------    ASKUSE85
      ISTAT = 0                                                         ASKUSE86
      NTRK = 0                                                          ASKUSE87
...
C------------------------------------------------------------           USCJOB 3
C! Interface routine for PHOJ01 generator                               USCJOB 4
C!  End of job - print out statistics etc.                              USCJOB 5
C! Author :-  A.J. Finch 1/6/96                                         USCJOB 6
C!     structure : subroutine                                           USCJOB 7
C -----------------------------------------------------------------     USCJOB 8
                                                                        USCJOB 9
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)                                USCJOB10
      INTEGER LMHLEN, LMHCOL, LMHROW                                    BCS    2
      PARAMETER (LMHLEN=2, LMHCOL=1, LMHROW=2)                          BCS    3
C                                                                       BCS    4
      COMMON /BCS/   IW(1000)                                           BCS    5
      ...
      EQUIVALENCE (RW(1),IW(1))                                         BCS    8
C                                                                       BCS    9
      common /evtsta/nevent(10)                                         BBL00129
      COMMON /XSECTP/ SIGTOT,SIGELA,SIGVM(0:4,0:4),SIGINE,SIGDIR,       USCJOB12
     &                SIGLSD(2),SIGHSD(2),SIGLDD,SIGHDD,SIGCDF,         USCJOB13
     &                SIGPOM,SIGREG,SIGHAR,SIGTR1,SIGTR2,SIGLOO,SIGDPO, USCJOB14
     &                SIG1SO,SIG1HA,SLOEL,SLOVM(4,4),SIGGEN(4),         USCJOB15
     &                FSUP(2)                                           USCJOB16
                                                                        USCJOB17
      COMMON /LEPCUT/ ECMIN,ECMAX,EEMIN1,EEMIN2,                        USCJOB18
     &                YMIN1,YMAX1,YMIN2,YMAX2,                          USCJOB19
     &                Q2MIN1,Q2MAX1,Q2MIN2,Q2MAX2,                      USCJOB20
     &                THMIN1,THMAX1,THMIN2,THMAX2                       USCJOB21
                                                                        USCJOB22
C                                                                       USCJOB23
      DOUBLE PRECISION EE1,EE2                                          CPHOJ  2
      COMMON/CPHJ01/EE1,EE2,LOUT,ILUMI,ILTOT                            CPHOJ  3
      real*4 EBEAM,WMIN,ELEC(5),POSI(5),LUMIF,QQ1,QQ2                   USCJOB25
      LOGICAL DEBUG                                                     USCJOB26
      PARAMETER(ALEPH_FUDGE=0.833)                                      USCJOB27
C                                                                       USCJOB28
      IFLAG = -1                                                        USCJOB29
      wmin = ecmin                                                      USCJOB30
      EBEAM = EE1                                                       USCJOB31
c                                                                       USCJOB32
c find the total lumi function for these settings                       USCJOB33
C                                                                       USCJOB34
      CALL GENLUM(IFLAG,EBEAM,WMIN,ELEC,POSI,LUMIF,QQ1,QQ2)             USCJOB35
C                                                                       USCJOB36
      ALUMI=LUMIF*FLOAT(ILUMI)/FLOAT(ILTOT)                             USCJOB37
      WRITE(6,10)                                                       USCJOB38
10    FORMAT(1H0///,                                                    USCJOB39
     1' Event generation complete statistics etc. follows...'           USCJOB40
     1////)                                                             USCJOB41
      WRITE(6,*)'                  '                                    USCJOB42
      WRITE(6,*)'                  '                                    USCJOB43
      WRITE(6,*)' Luminosity function =  ',ALUMI                        USCJOB44
      WRITE(6,*)' '                                                     USCJOB45
      WRITE(6,*)' '                                                     USCJOB46
      CALL EVENT(-2,P1,P2,FAC,IREJ)                                     USCJOB47
      WRITE(6,*)'                  '                                    USCJOB48
      WRITE(6,*)'                  '                                    USCJOB49
      WRITE(6,60)1000000.*SIGGEN(2)*ALUMI*ALEPH_FUDGE                   USCJOB50
60    FORMAT(1H0,//////' Total (e+ e-) cross section = ',               USCJOB51
     1F8.3,' nb '/////)                                                 USCJOB52
      WRITE(6,*)' '                                                     USCJOB53
      WRITE(6,*)' '                                                     USCJOB54
      ISTD = 0                                                          BBL00130
      JGSTD = NLINK('GSTD',0)                                           BBL00131
      IF(JGSTD.NE.0)THEN                                                BBL00132
         ISTD = IW(JGSTD+1)                                             BBL00133
      ENDIF                                                             BBL00134
      IF ( ISTD.eq.1) call STDSTA                                       BBL00135
      CALL AMCSTA                                                       BBL00136
      WRITE(6,*)' General statistics    '                               BBL00137
      WRITE(6,*)'                  '                                    BBL00138
      WRITE(6,*)' total generated =             ',nevent(1)             BBL00139
      WRITE(6,*)' kept after generation         ',nevent(2)             BBL00140
      WRITE(6,*)' kept after standard selection ',nevent(3)             BBL00141
      WRITE(6,*)' kept after user selection     ',nevent(4)             BBL00142
      WRITE(6,*)' kept after both selection     ',nevent(5)             BBL00143
      WRITE(6,*)' kept for control but failed   ',nevent(6)             BBL00144
      frac = float(nevent(5)) / float(nevent(2))                        BBL00145
      efrac = frac * sqrt(1./float(nevent(5))-1./float(nevent(2)))      BBL00146
      WRITE(6,*)' |--------------------------------------- '            BBL00147
      WRITE(6,*)' |  cross-section should be multiplied by '            BBL00148
      WRITE(6,*)' |  selection efficiency :',frac,' +- ',efrac          BBL00149
      WRITE(6,*)' |--------------------------------------- '            BBL00150
      RETURN                                                            USCJOB55
      END                                                               USCJOB56
