C----------------------------------------------------------------------
C     This is the ALEPH version from KORALZ-ALEPH (KORL07)
C     as cleaned up by Z. Was and B.Bloch in dec 98
C     common /TAUPOS/ was introduced
C     in addition : RANMAR code was renamed to avoid problems
C     of interferences with ALEPH RANMAR
CBB    set /HEPEVT/ as REAL*8 and MXHEP=4000
C-----------------------------------------------------------------------
      FUNCTION FORMOMx(XMAA,XMOM)
C     ==================================================================
...
* HADRON CURRENT
      ...
      FORMOMx=FQED*FRO**2/SQRT(2.0)*GCOUP**2*BWIGN(XMOM,AMOM,GAMOM)
...
C     =====
 ...
 7001 FORMAT(///1X,15(5H*****)
     ...
     $ /,' *',     25X,'**Old Private Aleph formfactor fixes***',9X,1H*,
     $ /,' *',     25X,'**To be used for background generation*',9X,1H*,
     $ /,' *',     25X,'*****Not for precision tau physics ****',9X,1H*,
