...
*
      IF(IMOMS.EQ.1) THEN
       ...
       CALL SEARCH(IHVP,IAMT4,IQCD,IMASS,IALEM,IBARB,AAFAC,DR,DRBIG,DRREM)
       DRF=DR
...
*
      ...
      SUBROUTINE SEARCH(IHVP,IAMT4,IQCD,IMASS,IALEM,IBARB,AAFAC,DR,DRBIG,DRREM)
*
      IMPLICIT REAL*8(A-H,O-W,Y-Z)
      IMPLICIT COMPLEX*16(X)
      COMMON/CDZSCT/ISCRE,ISCAL,IAFMT,IFACR,IFACT,IHIGS,IEWLC,ICZAK
...
*
     ...
     &                                    SCALER,AKFACI,AKFACL,AKFACR)
      ...
      IF(IAMT4.EQ.4.AND.INF.NE.10) THEN
       CALL FOKAPP(AQFI(INF),DR,DRBIG,DRREM,SCALER,ROFACI,AKFACI,AR1IM,AK1IM)
      ENDIF  
*
...
*
      ...
      SUBROUTINE FOKAPP(CH,DR,DRBIG,DRREM,SCALER,ROFACI,AKFACI,AR1IM,AK1IM)
*
