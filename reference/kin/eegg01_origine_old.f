...
C                                                                               
C                                                                               
C Simple Main Program example for the TEEGG generator                           
      PROGRAM TEEGGM                                                            
...
C Set defaults for TEEGG                                                        
      CALL TEEGGI                                                               
C Initialize any constants                                                      
C.....NEV =  number of events requested                                         
      NEV =  100                                                                
C Let the CTRL routine take over the execution                                  
C TEEGGX calls TEEGGS to generate NEV events.                                   
      CALL TEEGGX                                                               
C All done.                                                                     
      STOP                                                                      
      END                                                                       
