C***********************************************************************
C $Id: arinit.f,v 3.0 1992/07/17 14:57:09 lonnblad Exp $
C**********************************************************************C
C                                                                      C
C                            A R I A D N E                             C
C                                                                      C
...
C                                                                      C
C                        Version 4 revision 04                         C
C                  Latest date of change: Dec 17 1992                  C
C                                                                      C
C                              Author :                                C
C                                                                      C
C                           Leif Lonnblad                              C
...
C...Set quark masses
 ...
 1000 FORMAT(/,14X,
     $     'The Lund Monte Carlo - Ariadne version 4 revision 04',
     $     /,23X,'Latest date of change: Dec 17 1992')
...
C...PARA(11)(D=0.600) Soft suppression parameter for code 1
C...PARA(12)(D=0.600) Soft suppression parameter for code 2
...
C...PARA(25)(D=0.000) exponent in propability for having a larger
...
C...MSTA(25)(D=0)     Generation procedure for exetended dipoled
C...         0 =>      Using restricted phase space
C...         1 =>      Using full phase space rejecting unphysical
C...                 emissions allowing larger fractions of a according
C...                 to PARA(25)
C...         2 =>    as 1 but new definition of p_T for calculation of a
...
C**** END OF ARDATA ****************************************************
      END
C***********************************************************************
C $Id: araddg.f,v 3.0 1992/07/17 14:56:39 lonnblad Exp $
...
C**** END OF ARADDG ****************************************************
      END
C***********************************************************************
C $Id: arangl.f,v 3.1 1992/11/23 14:33:42 lonnblad Exp $
...
C**** END OF ARANGL ****************************************************
      END
C***********************************************************************
C $Id: arbocm.f,v 3.0 1992/07/17 14:56:41 lonnblad Exp $
...
C**** END OF ARBOCM ****************************************************
      END
C***********************************************************************
C $Id: arcasc.f,v 3.1 1992/11/23 14:33:43 lonnblad Exp $
...
C...Entry for continuing interupted cascade
      ENTRY ARCONT
...
C**** END OF ARCASC ****************************************************
      END
C***********************************************************************
C $Id: archem.f,v 3.0 1992/07/17 14:56:43 lonnblad Exp $
...
C**** END OF ARCHEM ****************************************************
      END
C***********************************************************************
C $Id: arclus.f,v 3.2 1992/12/17 10:36:04 lonnblad Exp $
...
C**** END OF ARCLUS ****************************************************
      END
C***********************************************************************
C $Id: arcopa.f,v 3.0 1992/07/17 14:56:46 lonnblad Exp $
...
C**** END OF ARCOPA ****************************************************
      END
C***********************************************************************
C $Id: arcopj.f,v 3.2 1992/12/17 10:36:52 lonnblad Exp $
...
C**** END OF ARCOPJ ****************************************************
      END
C***********************************************************************
C $Id: arcrdi.f,v 3.0 1992/07/17 14:56:48 lonnblad Exp $
...
C**** END OF ARCRDI ****************************************************
      END
C***********************************************************************
C $Id: ardump.f,v 3.0 1992/07/17 14:56:56 lonnblad Exp $
...
C**** END OF ARDUMP ****************************************************
      END
C***********************************************************************
C $Id: arduph.f,v 3.0 1992/07/17 14:56:57 lonnblad Exp $
...
C**** END OF ARDUPH ****************************************************
      END
C***********************************************************************
C $Id: ardyre.f,v 3.0 1992/07/17 14:56:58 lonnblad Exp $
...
C**** END OF ARDYRE ****************************************************
      END
C***********************************************************************
C $Id: aremit.f,v 3.0 1992/07/17 14:56:59 lonnblad Exp $
...
C...the recoil gluon from the trial emission is kept.
     ...
     $       (MSTA(18).GT.1.OR.PT21.GT.PARA(10+IEX(IS1))**2))
     ...
     $       (MSTA(18).GT.1.OR.PT23.GT.PARA(10+IEX(IS3))**2))
...
C**** END OF AREMIT ****************************************************
      END
C***********************************************************************
C $Id: arerrm.f,v 3.1 1992/12/17 10:37:04 lonnblad Exp $
...
C**** END OF ARERRM ****************************************************
      END
C***********************************************************************
C $Id: arexec.f,v 3.0 1992/07/17 14:57:01 lonnblad Exp $
...
C**** END OF AREXEC ****************************************************
      END
C***********************************************************************
C $Id: argpt2.f,v 3.0 1992/07/17 14:57:03 lonnblad Exp $
...
C**** END OF ARGPT2 ****************************************************
      END
C***********************************************************************
C $Id: argqcd.f,v 3.1 1992/11/23 14:33:46 lonnblad Exp $
...
C**** END OF ARGQCD ****************************************************
      END
C***********************************************************************
C $Id: argqed.f,v 3.0 1992/07/17 14:57:06 lonnblad Exp $
...
C**** END OF ARGQED ****************************************************
      END
C***********************************************************************
C $Id: argtyp.f,v 3.0 1992/07/17 14:57:07 lonnblad Exp $
...
C**** END OF ARGTYP ****************************************************
      END
C***********************************************************************
C $Id: aript2.f,v 3.0 1992/07/17 14:57:14 lonnblad Exp $
...
C**** END OF ARIPT2 ****************************************************
      END
C***********************************************************************
C $Id: arjoin.f,v 3.2 1992/12/17 10:37:21 lonnblad Exp $
...
C...Determine recoil angle
      BET=ARANGL(J1,J3)
      PSI=0.0
C      IF(MSTA(40).EQ.1) THEN
C        IF(B3.GT.B1) PSI=PARU(1)-BET
C      ELSEIF(MSTA(40).EQ.2) THEN
C        IF(B3**2.GT.RLU(IDUM)*(B1**2+B3**2)) PSI=PARU(1)-BET
C      ELSE
...
C**** END OF ARJOIN ****************************************************
      END
C***********************************************************************
C $Id: armade.f,v 3.0 1992/07/17 14:57:16 lonnblad Exp $
...
C**** END OF ARMADE ****************************************************
      END
C***********************************************************************
C $Id: armass.f,v 3.0 1992/07/17 14:57:17 lonnblad Exp $
...
C**** END OF ARMASS ****************************************************
      END
C***********************************************************************
C $Id: armcdi.f,v 3.0 1992/07/17 14:57:18 lonnblad Exp $
...
C**** END OF ARMCDI ****************************************************
      END
C***********************************************************************
C $Id: armipt.f,v 3.0 1992/07/17 14:57:19 lonnblad Exp $
...
C**** END OF ARMIPT ****************************************************
      END
C***********************************************************************
C $Id: arnofl.f,v 3.0 1992/07/17 14:57:21 lonnblad Exp $
...
C**** END OF ARNOFL ****************************************************
      END
C***********************************************************************
C $Id: arordj.f,v 3.1 1992/12/17 10:37:53 lonnblad Exp $
...
C**** END OF ARORDJ ****************************************************
      END
C***********************************************************************
C $Id: arorie.f,v 3.0 1992/07/17 14:57:23 lonnblad Exp $
...
C**** END OF ARECOI ****************************************************
      END
C***********************************************************************
C $Id: arpars.f,v 3.0 1992/07/17 14:57:25 lonnblad Exp $
...
C**** END OF ARPARS ****************************************************
      END
C***********************************************************************
C $Id: arradg.f,v 3.0 1992/07/17 14:57:31 lonnblad Exp $
...
C**** END OF ARRADG ****************************************************
      END
C***********************************************************************
C $Id: arradp.f,v 3.0 1992/07/17 14:57:33 lonnblad Exp $
...
C**** END OF ARRADP ****************************************************
      END
C***********************************************************************
C $Id: arradq.f,v 3.0 1992/07/17 14:57:34 lonnblad Exp $
...
C**** END OF ARRADQ ****************************************************
      END
C***********************************************************************
C $Id: arreca.f,v 3.0 1992/07/17 14:57:35 lonnblad Exp $
...
C**** END OF ARRECA ****************************************************
      END
C***********************************************************************
C $Id: arupdj.f,v 3.2 1992/12/17 10:38:20 lonnblad Exp $
...
C...since last call
     ...
     $                QEM(MAXDIP),IRAD(MAXDIP),ISTR(MAXDIP),IDIPS
      ...
      IF(I1.EQ.0.OR.QDONE(IDI(I2)).OR.QDONE(IDO(I2)).OR.
     $     I2.EQ.I1.OR.I2.EQ.I3.OR.IDI(I2).EQ.I1.OR.IDO(I2).EQ.I3) THEN
...
C**** END OF ARUPDJ ****************************************************
      END
C***********************************************************************
C $Id: arrndx.f,v 3.0 1992/07/17 14:57:36 lonnblad Exp $
...
C**** END OF ARNDX3 ****************************************************
      END
C***********************************************************************
C $Id: arrndy.f,v 3.0 1992/07/17 14:57:37 lonnblad Exp $
...
C...Suitable for gluon emission from extended dipole
     ...
     $                AE1,AE3,NXP1,NXP3,FQ1,FQ3
      ...
      AE1=1.0
      AE3=1.0
      IF(MSTA(25).GT.0) ARNDY2=ARNDY1()
      PTTRUE=XT*W
      IF(MSTA(25).EQ.2) THEN
        B1=-XT*EXP(ARNDY2)-BC1
        B3=-XT*EXP(-ARNDY2)-BC3
        B2=2.0-B1-B3
        IF((1.0-B1+Y1-(SY2+SY3)**2)*(1.0-B3+Y3-(SY1+SY2)**2).GE.
     $       0.25*(1.0-B2+Y2-(SY1+SY3)**2)) THEN
          PTTRUE=0.5*W
        ELSE
          PTTRUE=W*SQRT((1.0-B1+Y1-(SY2+SY3)**2)*
     $         (1.0-B3+Y3-(SY1+SY2)**2)/(1.0-B2+Y2-(SY1+SY3)**2))
        ENDIF
      ENDIF
 
      IF(MSTA(25).GT.0) THEN
        IF(NE1.GT.0) AE1=((PARA(10+NE1)/PTTRUE)**PARA(10))*
     $       (1.0/RLU(IDUM)-1.0)**PARA(25)
        IF(NE3.GT.0) AE3=((PARA(10+NE3)/PTTRUE)**PARA(10))*
     $       (1.0/RLU(IDUM)-1.0)**PARA(25)
...
C...Suitable for q-qbar emission from extended dipole
     ...
     $                AE1,AE3,NXP1,NXP3,FQ1,FQ3
      ...
      AE3=1.0
      PTTRUE=XT*W
      IF(MSTA(25).GT.0) ARNDY4=ARNDY3()
      IF(MSTA(25).EQ.2) THEN
        B1=-XT*EXP(ARNDY4)-BC1
        B3=-XT*EXP(-ARNDY4)-BC3
        B2=2.0-B1-B3
        IF((1.0-B1+Y1-(SY2+SY3)**2)*(1.0-B3+Y3-(SY1+SY2)**2).GE.
     $       0.25*(1.0-B2+Y2-(SY1+SY3)**2)) THEN
          PTTRUE=0.5*W
...
C**** END OF ARNDY4 ****************************************************
      END
C***********************************************************************
C $Id: arrobo.f,v 3.0 1992/07/17 14:57:38 lonnblad Exp $
...
C**** END OF ARROBO ****************************************************
      END
C***********************************************************************
C $Id: arsplg.f,v 3.0 1992/07/17 14:57:39 lonnblad Exp $
...
C**** END OF ARSPLG ****************************************************
      END
C***********************************************************************
C $Id: arstor.f,v 3.0 1992/07/17 14:57:40 lonnblad Exp $
...
C**** END OF ARSTOR ****************************************************
      END
C***********************************************************************
C $Id: artest.f,v 3.0 1992/07/17 14:57:42 lonnblad Exp $
...
C**** END OF ARTEST ****************************************************
      END
C***********************************************************************
C $Id: arveto.f,v 3.0 1992/07/17 14:57:45 lonnblad Exp $
...
C***********************************************************************
C $Id: artune.f,v 3.0 1992/07/17 14:57:43 lonnblad Exp $
...
C**** END OF ARTUNE ****************************************************
      END
C***********************************************************************
C $Id: arprda.f,v 3.0 1992/07/17 14:57:30 lonnblad Exp $
...
C**** END OF ARPRDA ****************************************************
      END
C***********************************************************************
C $Id: archki.f,v 3.0 1992/07/17 14:56:44 lonnblad Exp $
...
C**** END OF ARCHKI ****************************************************
      END
C***********************************************************************
C $Id: arexma.f,v 3.0 1992/07/17 14:57:02 lonnblad Exp $
