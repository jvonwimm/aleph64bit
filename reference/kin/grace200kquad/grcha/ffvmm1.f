...
*------------------------ Entry point ----------------------------------
   ...
   90 CONTINUE
      ...
      IF( LIND .EQ. 1 ) THEN
          ...
          LP1      = .TRUE.
          LP2      = .TRUE.
          IF( Q1(4) .LE. 0.0q0 ) LQ1 = .FALSE.
          IF( Q2(4) .LE. 0.0q0 ) LQ2 = .FALSE.
          IF( P1(4) .LE. 0.0q0 ) LP1 = .FALSE.
          IF( P2(4) .LE. 0.0q0 ) LP2 = .FALSE.
C-
          IF( LQ1 ) THEN
               PT1        = SQRT(Q1(2)*Q1(2) + Q1(3)*Q1(3))
               IF( PT1 .LE. 0.0q0) THEN
