...
*//  possible!!  
*///////////////////////////////////////////////////////////////////////
C.  B.Bloch September 5, 2001 : under advice of Z.WAS modify XPHCUT=0.01D0
C.                              to XPHCUT=0.02D0 to avoid over radiation
C>                              in Z-->e+e- decays
C   J.von Wimmersperg 2019    : implemented bug fix first introduced in V2.09
C                               which solves the "too much bremsstrahlung"
C                               problems. XPHCUT changed back to 0.01D0 
C     .----------------------------------------------------------------------
C.
...
C--   Set cut parameter for photon radiation
      XPHCUT=0.01D0
*JVW  XPHCUT=0.02D0 !new value to avoid problems lets hope that it would
*                   ! be enough (jvw commented out, implemented bug fix from
*                     version 2.09 - see PHOENE and PHOFAC routines)
